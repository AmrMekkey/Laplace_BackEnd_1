...
private:
    ...
    size_t token_idx_;
    // Removed parsed_terms_ as it's no longer needed for direct storage within parser
    ...
    // Removed combine_multiplied_terms as its logic is now integrated into parse_multiplication
};
